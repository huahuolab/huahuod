...
We don't recommend macos for huahuo production use at this time. Currently, the
...
modification, build huahuo using clang, and run the system tests you will need
...
should satisfy the the minimum version requirements for huahuo.
...
listed on [GitHub](https://github.com/ripple/huahuo/releases GitHub). 
